                ...
                children: [
                  ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index0) {
                        ...
                        if (menuCategories[index].categoryName.toLowerCase() ==
                        ...
                        return Column(
                            children: L
                                .map((ee) => ExpansionTile(
                                      initiallyExpanded: true,
                                      title: Text(ee.toString().toUpperCase(),
                                          style: const TextStyle(
                                        ...
                                        Builder(builder: (context) {
                                          for (var i = 0;
                                            ...
                                            if (ee ==
                                              ...
                                              if (menuItem.vegan == true &&
                                                  user == true) {
                                                C.add(ListForRO(
                                                    img: menuItems[i]
                                                        .pdpImageUrl,
                                                    title: menuItems[i].title,
                                                    totalCalories: menuItems[i]
                                                        .totalCalories
                                                        .value
                                                        .toString(),
                                                    price: menuItems[i]
                                                        .price
                                                        .toString(),
                                                    offerDetails: menuItems[i]
                                                            .offerDetails ??
                                                        ''));
                                              } else if (menuItem.vegan ==
                                                      false &&
                                                  user == false) {
                                                C.add(ListForRO(
                                                    img: menuItems[i]
